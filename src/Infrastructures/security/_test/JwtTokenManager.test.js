...
describe('JwtTokenManager', () => {
  ...
  describe('verifyRefreshToken function', () => {
    it('should throw InvariantError when verification failed', async () => {
      ...
      const accessToken = await jwtTokenManager.createAccessToken({ username: 'arsad' });
  ...
  describe('verifyAccessToken function', () => {
    it('should throw AuthenticationError when verification failed', async () => {
      ...
      // Action & Assert
      await expect(jwtTokenManager.verifyAccessToken(refreshToken)).rejects.toThrow(
        AuthenticationError,
      );
    });
  ...
  describe('decodePayload function', () => {
    it('should decode payload correctly', async () => {
      ...
      // Action & Assert
      expect(expectedUsername).toEqual('arsad');
    });
  });
});
